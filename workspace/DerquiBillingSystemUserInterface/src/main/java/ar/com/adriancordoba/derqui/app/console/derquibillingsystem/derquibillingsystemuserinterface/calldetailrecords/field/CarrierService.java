 ...
 *
 */
public class CarrierService extends TicketField {
	...
	private static final long serialVersionUID = 4412078482870837332L;

	public CarrierService(char code) throws Exception {
		super(code);
		if (code != '0' && code != '1' && code != '2' && code != '3') {
			logger.error("Carrier Service not defined: " + code + ".");
	...
	public String getMeaning() {
		...
		switch (getCode()) {
		case '0':
			meaning = bundle.getString("Fields.CarrierService_0");
			break;
		case '1':
			meaning = bundle.getString("Fields.CarrierService_1");
			break;
		case '2':
			meaning = bundle.getString("Fields.CarrierService_2");
			break;
		case '3':
			meaning = bundle.getString("Fields.CarrierService_3");
		}
